...
マスタシートと収集シートのデータを結合し、最新の状態を含む統合ビューを提供するシート。QUERY関数とVLOOKUP関数を使用して自動的にデータを結合。
...
| O      | 預りユーザー機シリアル  | String   | 収集シート           | 1-7.預りユーザー機のシリアルNo.         | USER_ABC123                  |
| P      | お預かり証No            | String   | 収集シート           | 1-8.お預かり証No.                       | RECEIPT_001                  |
...
| Y      | formURL                 | String   | マスタ               | 個別フォームURL                         | https://forms.google.com/... |
| Z      | QRコードURL             | String   | マスタ               | QRコード用URL                           | https://script.google.com/...|
